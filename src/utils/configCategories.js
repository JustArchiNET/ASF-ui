...
const asfCategories = [
  ...
  { name: Vue.i18n.translate('trade'), fields: ['MaxTradeHoldDuration', 'FilterBadBots', 'LicenseID'] },
  ...
  { name: Vue.i18n.translate('farming'), fields: ['FarmingDelay', 'IdleFarmingPeriod', 'MaxFarmingTime', 'MinFarmingDelayAfterBlock', 'ShutdownIfPossible'] },
...
const uiCategories = [
  ...
  { name: Vue.i18n.translate('bots'), fields: [Vue.i18n.translate('bot-nicknames'), Vue.i18n.translate('bot-game-name'), Vue.i18n.translate('bot-order-numeric'), Vue.i18n.translate('bot-order-disabled'), Vue.i18n.translate('bot-fav-buttons')] },
  { name: Vue.i18n.translate('commands'), fields: [Vue.i18n.translate('timestamps')] },
  { name: Vue.i18n.translate('log'), fields: [Vue.i18n.translate('log-previous-amount'), Vue.i18n.translate('log-information'), Vue.i18n.translate('log-timestamp')] },
];
