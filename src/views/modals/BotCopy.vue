    ...
    <div class="container">
      ...
      <div class="form-item">
        <div class="form-item__buttons">
          ...
          >
            <button class="button button--cancel pull-right" @click="navigate">
              {{ $t("cancel") }}
            </button>
          </router-link>
        </div>
  ...
  data() {
    const fields = [
      ...
      },
      {
        ...
        type: "string",
        description: get(`cache:parameter-descriptions:${this.$i18n.locale}`)
          .descriptions.SteamLogin,
      },
      {
        defaultValue: "",
        param: "SteamPassword",
