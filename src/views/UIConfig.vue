...
export default {
    ...
    return {
      ...
      model: {
        ...
        orderDisabledBotsLast:
          this.$store.getters["settings/orderDisabledBotsLast"],
  ...
  methods: {
    async save() {
      ...
      this.$store.dispatch(
        "settings/setNotificationPosition",
        this.model.notificationPosition
      );
      this.$store.dispatch(
        "settings/setNotifyRelease",
        this.model.notifyRelease
      );
      this.$store.dispatch(
        "settings/setDisplayCategories",
        this.model.displayCategories
      );
      ...
      this.$store.dispatch(
        "settings/setOrderDisabledBotsLast",
        this.model.orderDisabledBotsLast
      );
      this.$store.dispatch(
        "settings/setPreviousAmount",
        this.model.previousAmount
      );
      this.$store.dispatch(
        "settings/setLogInformation",
        this.model.logInformation
      );
      this.$store.dispatch("settings/setLogTimestamp", this.model.logTimestamp);
      this.$store.dispatch(
        "settings/setOrderBotsNumeric",
        this.model.orderBotsNumeric
      );
