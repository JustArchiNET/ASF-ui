...
if (defaultView === "_last-visited-page")
  defaultView = storage.get("last-visited-page", routes.home);
  ...
  },
  {
    ...
    async beforeEnter(to, from, next) {
      ...
      if (botsDetected) {
        ...
        let defaultView = store.getters["settings/defaultView"];
        if (defaultView === "_last-visited-page")
          defaultView = storage.get("last-visited-page", routes.bots);
        if (
          !Object.values(routes).includes(defaultView) ||
