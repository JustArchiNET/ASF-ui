    ...
    <transition name="navigation__language-picker">
      <div v-if="languageMenu" class="navigation__language-picker">
        <div
          ...
          :class="{ 'navigation__language--active': $i18n.locale === locale }"
  ...
  methods: {
    ...
    displayTranslationStatus() {
      ...
      if (translationPercent > 80)
        return this.$info(
          this.$t("language-translation-good", {
      ...
      if (translationPercent > 40)
        return this.$info(
          this.$t("language-translation-medium", {
            percent: translationPercent.toFixed(2),
            locale: this.$i18n.locale,
          })
        );
      return this.$info(
        this.$t("language-translation-bad", {
          percent: translationPercent.toFixed(2),
          locale: this.$i18n.locale,
        })
      );
...
.navigation__language-picker-enter,
.navigation__language-picker-leave-to {
  transform: scaleY(0);
}
</style>
