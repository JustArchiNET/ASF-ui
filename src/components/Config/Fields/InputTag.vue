  ...
  <div class="form-item">
    ...
    <div class="form-item__value">
      <div class="input-option__field">
        <div
          class="form-item__input form-item__input--tag-wrapper"
          :class="{ 'form-item__input--focus': focus }"
        >
          <button
          ...
          <input
            v-model="element"
            class="form-item__input form-item__input--tag"
            type="text"
            @keydown="onKeyDown"
            @focus="onFocus"
            @blur="onBlur"
...
export default {
  ...
  computed: {
    ...
    errors() {
      if (
        Object.prototype.hasOwnProperty.call(validator, this.schema.values.type)
      )
        return validator[this.schema.values.type](this.element);
      return [];
    },
    isValid() {
      return true;
