<template>
  ...
  >
    <div
      ...
      :class="{ 'form-item__description--shown': shown }"
    >
...
.form-item__description-enter,
.form-item__description-leave-to {
  opacity: 0;
}

.form-item__description-enter-active,
.form-item__description-leave-active {
