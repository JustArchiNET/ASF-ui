<template>
	<div class="form-item">
		...
		<input class="form-item__input" type="number" :name="field" :id="field" :placeholder="placeholder" :required="required" :class="{ error: invalid }" v-model.number="value" @blur="onBlur">
