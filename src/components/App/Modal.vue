    ...
    <div v-if="isShown" class="modal">
      ...
      <div class="modal__body">
        ...
        <FontAwesomeIcon
          v-if="showArrows"
          icon="chevron-left"
          class="modal__arrow left"
          @click="next('left')"
        ></FontAwesomeIcon>
        <FontAwesomeIcon
          v-if="showArrows"
          icon="chevron-right"
          class="modal__arrow right"
          @click="next('right')"
        ></FontAwesomeIcon>
...
export default {
  ...
  methods: {
    ...
    next(direction) {
      const currentIndex = this.bots.findIndex(
        (bot) => bot.name === this.$route.params.bot
      );
      ...
      this.$router.push({
        ...
        params: { bot: this.bots[targetIndex].name },
      });
    },
  },
};
